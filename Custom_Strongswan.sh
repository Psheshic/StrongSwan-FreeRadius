...
apt-get -y install libiptc-dev;

apt-get -y install libip4tc-dev

apt-get -y install libmysqlclient-dev              #для MySQL


wget https://download.strongswan.org/strongswan-5.9.6.tar.bz2

tar xjf strongswan-5.9.6.tar.bz2;

cd strongswan-5.9.6

./configure --prefix=/usr --sysconfdir=/etc --enable-acert --enable-openssl --enable-eap-aka --enable-eap-gtc --enable-eap-identity --enable-eap-md5 --enable-eap-radius --enable-eap-tls --enable-eap-tnc --enable-eap-ttls --enable-xauth-eap --enable-eap-mschapv2 --enable-addrblock --enable-aesni --enable-agent --enable-connmark --enable-dhcp --enable-eap-dynamic --enable-eap-peap --enable-farp --enable-gcm --enable-xauth-pam --enable-certexpire --disable-cmac --disable-curve25519 --disable-des --enable-error-notify --enable-lookip --enable-led --enable-unity --enable-eap-radius
